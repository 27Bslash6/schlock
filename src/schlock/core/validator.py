...
def validate_command(command: str, config_path: Optional[str] = None, *, _depth: int = 0) -> ValidationResult:
    ...
    result = _validate_command(command, config_path, _depth=_depth, _deferred=deferred)
    if not deferred:
        return result
